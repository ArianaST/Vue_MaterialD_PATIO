...
import "bootstrap/dist/js/bootstrap.bundle.min.js"; // Verifica que Bootstrap esté correctamente cargado
...
<template>
  <nav
    class="navbar bg-white navbar-expand-lg w-100 top-0"
    :class="{
  ...
  >
    <div :class="props.transparent || props.light || props.dark ? 'container' : 'container-fluid px-0 '">
      ...
      <RouterLink
        ...
        :class="props.transparent || props.dark ? 'text-dark' : 'font-weight-bolder ms-sm-3'"
        to="/"
        rel="tooltip"
        title="PATITO"
        data-placement="bottom-image"
